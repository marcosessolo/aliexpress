        ...
        <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
            <ul class="flex items-center justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#FAFAFA] max-w-[1200px]">
                ...
                <li class="px-3 hover:text-[#FF4646] cursor-pointer">
                    <font-awesome-icon :icon="['fas', 'file-arrow-down']" class="mr-1" />
                    App 
                </li>
                <li @mouseenter="isAccountMenu = true" @mouseleave="isAccountMenu = false" 
                    ...
                    Account
                    <font-awesome-icon :icon="['fas', 'chevron-down']" class="mr-1 ml-5" />
        ...
        <div id="MainHeader" class="flex items-center w-full bg-white">
            <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
                ...
                <div class="max-w-[700px] w-full md:block hidden">
                    <div class="relative">
                        <div class="flex items-center border-2 border-[#FF4646] rounder-md w-full ">
                            <input 
                            class="w-full placeholder-gray-400 text-sm pl-3 focus:outline-none" 
                            type="text"
                            placeholder="kitchen accessories"
                            v-model="searchItem">
                            <font-awesome-icon :icon="['fas', 'gear']" spin  v-if="isSearching" class="mr-2" />
                            <button class="flex items-center h-[100%] p-1.5 px-2 bg-[#FF4646]">
                                <font-awesome-icon color="#ffffff" :icon="['fas', 'magnifying-glass']" />
                            </button>
                        </div>
                            ...
                            <div v-if="false" class="p-1">
                                <NuxtLink to="`/item/1`" class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-100">
                                    <div class="flex items-center">
                                        <img class="rounded-md" width="40" src="https://picsum.photos/id/82/300/300" alt="picsum">
                ...
                <NuxtLink to="/shoppingcart" class="flex items-center">
                    <button class="relative md:block hidden" @mouseenter="isCartHover = true" @mouseleave="isCartHover = false">
                        ...
                        <div class="min-w-[40px]">
                            <font-awesome-icon :color="isCartHover ? '#FF4646' : ''" :icon="['fas', 'cart-shopping']" size="lg" />
                        </div>
                    </button>
                </NuxtLink>
